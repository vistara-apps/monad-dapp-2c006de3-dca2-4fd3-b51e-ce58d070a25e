  ...
  if (!address || !playerStats) {
    return (
      <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
        <p className="text-gray-400 text-center">Connect wallet to view stats</p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-gray-400 text-sm">Total Minted</h3>
        </div>
        <p className="text-3xl font-bold text-white">
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-gray-400 text-sm">Cooldown</h3>
        </div>
        <p className="text-3xl font-bold text-white">
      ...
      <div className="md:col-span-3 bg-gray-800 rounded-xl p-6 border border-gray-700">
        <div className="flex justify-between items-center mb-2">
          <h3 className="text-gray-400 text-sm">Global Supply</h3>
